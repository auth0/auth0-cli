...
func DetectProject(dir string) DetectionResult {
	...
	// ── 2. Manage.py (Django) — checked BEFORE angular.json so that a Django
	// project co-located with an Angular workspace is detected as Django, not Angular.
	// manage.py is universally generated by django-admin startproject and is
	// unique to Django — no other Python framework produces it.
