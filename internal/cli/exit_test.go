...
func TestErrorClass(t *testing.T) {
	tests := []struct {
		...
		{name: "409 conflict", err: fakeManagementError{status: 409}, expected: "conflict"},
		{name: "410 gone", err: fakeManagementError{status: 410}, expected: "validation"},
		{name: "415 unsupported media type", err: fakeManagementError{status: 415}, expected: "validation"},
...
func TestErrorReason(t *testing.T) {
	tests := []struct {
		...
		{name: "404 not found", err: fakeManagementError{status: 404}, expected: "not_found"},
		{name: "409 conflict", err: fakeManagementError{status: 409}, expected: "conflict"},
		{name: "410 gone", err: fakeManagementError{status: 410}, expected: "gone"},
		{name: "415 unsupported media type", err: fakeManagementError{status: 415}, expected: "unsupported_media_type"},
