...
has_toc: false
---
# auth0 guardian factors phone show-twilio

Display the Twilio configuration for the phone MFA factor.
...
## Usage
```
auth0 guardian factors phone show-twilio [flags]
```

## Examples

```
  auth0 guardian factors phone show-twilio --json
```
