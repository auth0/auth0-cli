...
has_toc: false
---
# auth0 guardian factors sms show-twilio

Display the Twilio configuration for the SMS MFA factor.
...
## Usage
```
auth0 guardian factors sms show-twilio [flags]
```

## Examples

```
  auth0 guardian factors sms show-twilio --json
```
