...
has_toc: false
---
# auth0 guardian factors phone set-templates

Set the phone enrollment and verification message templates.

This is a legacy endpoint. Tenants on the unified phone experience must manage phone templates from the Dashboard (Branding > Phone Templates); it is not available to Management API tokens.

## Usage
```
auth0 guardian factors phone set-templates [flags]
```
...
```
      --enrollment-message string     Message sent to the user when they enroll.
      --json                          Output in json format.
      --json-compact                  Output in compact json format.
      --verification-message string   Message sent to the user when they verify.
```
