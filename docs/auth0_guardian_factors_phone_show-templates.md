...
has_toc: false
---
# auth0 guardian factors phone show-templates

Display the phone enrollment and verification message templates.
...
## Usage
```
auth0 guardian factors phone show-templates [flags]
```

## Examples

```
  auth0 guardian factors phone show-templates --json
```
