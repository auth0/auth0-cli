...
has_toc: false
---
# auth0 guardian factors push set-fcm

Replace the Google FCM (legacy) push-notification configuration.

## Usage
```
auth0 guardian factors push set-fcm [flags]
```

## Examples

```
  auth0 guardian factors push set-fcm --server-key <server-key>
```
