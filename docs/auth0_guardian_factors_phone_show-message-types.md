...
has_toc: false
---
# auth0 guardian factors phone show-message-types

Display the enabled phone message types (sms, voice).

## Usage
```
auth0 guardian factors phone show-message-types [flags]
```

## Examples

```
  auth0 guardian factors phone show-message-types --json
```
