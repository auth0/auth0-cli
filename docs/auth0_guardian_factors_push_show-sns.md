...
has_toc: false
---
# auth0 guardian factors push show-sns

Display the Amazon SNS push-notification configuration.

## Usage
```
auth0 guardian factors push show-sns [flags]
```

## Examples

```
  auth0 guardian factors push show-sns --json
```
