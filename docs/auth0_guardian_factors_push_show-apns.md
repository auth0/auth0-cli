...
has_toc: false
---
# auth0 guardian factors push show-apns

Display the Apple Push Notification service (APNs) configuration.

## Usage
```
auth0 guardian factors push show-apns [flags]
```

## Examples

```
  auth0 guardian factors push show-apns --json
```
