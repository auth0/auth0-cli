...
has_toc: false
---
# auth0 guardian factors push show-provider

Display the configured push-notification MFA provider.

## Usage
```
auth0 guardian factors push show-provider [flags]
```

## Examples

```
  auth0 guardian factors push show-provider --json
```
