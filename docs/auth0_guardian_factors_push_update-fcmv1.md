...
has_toc: false
---
# auth0 guardian factors push update-fcmv1

Partially update the Google FCM v1 push-notification configuration.

## Usage
```
auth0 guardian factors push update-fcmv1 [flags]
```

## Examples

```
  auth0 guardian factors push update-fcmv1 --server-credentials "$(cat service-account.json)"
```
